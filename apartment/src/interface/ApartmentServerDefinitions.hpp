...
#ifndef __ENTRYPHONE_APARTMENT_SERVER_DEFINITIONS_HPP__
#define __ENTRYPHONE_APARTMENT_SERVER_DEFINITIONS_HPP__
...
#endif /* __ENTRYPHONE_APARTMENT_SERVER_DEFINITIONS_HPP__ */
